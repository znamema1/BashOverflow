...
return array(
    ...
    'list_script_no_vote' => 'Please view this script to vote',
    'error_script_name' => 'Script name must be ^1-^2 characters long!',
    'error_script_desc' => 'Script description must be ^1-^2 characters long!',
    'error_script_tags_count' => 'Script can have ^1-^2 tags!',
    'error_script_tags_length' => 'Script tag must be ^1-^2 characters long!',
    'error_script_example_data' => 'Example data must be ^1-^2 characters long!',
    'error_script_comm_msg' => 'Commit message is mandatory! Must be ^1-^2 characters long!',
    'error_script_git_format' => 'Link to GitHub must match \'^1\' regex!',
    'error_script_file_format' => 'File path cannot start witch \'.\' and can be ^1-^2 characters long!!',
    'error_script_comm_format' => 'Commit hash must be ^1-^2 characters long!',
    ...
    'plugin_bash_overflow_server_url' => 'Execute server URL:',
    'plugin_bash_overflow_script_name_min_len' => 'Script name min lenght:',
    'plugin_bash_overflow_script_name_max_len' => 'Script name max lenght:',
    'plugin_bash_overflow_script_desc_min_len' => 'Script description min lenght:',
    'plugin_bash_overflow_script_desc_max_len' => 'Script description max lenght:',
    'plugin_bash_overflow_script_tag_min_count' => 'Script tags min count :',
    'plugin_bash_overflow_script_tag_max_count' => 'Script tags max count:',
    'plugin_bash_overflow_script_tag_min_len' => 'Script tag min lenght:',
    'plugin_bash_overflow_script_tag_max_len' => 'Script tag max lenght:',
    'plugin_bash_overflow_script_example_min_len' => 'Script example data min lenght:',
    'plugin_bash_overflow_script_example_max_len' => 'Script example data max lenght:',
    'plugin_bash_overflow_script_comm_msg_min_len' => 'Script commit message min lenght:',
    'plugin_bash_overflow_script_comm_msg_max_len' => 'Script commit message max lenght:',
    'plugin_bash_overflow_script_git_regex' => 'GitHub link string regex:',
    'plugin_bash_overflow_script_file_min_len' => 'Script file min lenght:',
    'plugin_bash_overflow_script_file_max_len' => 'Script file max lenght:',
    'plugin_bash_overflow_script_comm_min_len' => 'Script commit min lenght:',
    'plugin_bash_overflow_script_comm_max_len' => 'Script commit max lenght:',
);
